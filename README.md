...
- **Balanced Accuracy Delta**: `-0.0227` (Logistic Regression is superior by +2.27%)
- **p95 Latency Delta**: `+12.572 ms` (Logistic Regression is ~28.9× faster at batch size 1)

### Hypothesis Outcomes
- **Hypothesis 1** (*"random_forest achieves higher balanced_accuracy than logistic_regression"*): **NOT SUPPORTED**
- **Hypothesis 2** (*"logistic_regression achieves lower p95_latency_ms than random_forest"*): **SUPPORTED**

All values and deltas were computed deterministically by the ML engine and evidence comparator; zero numbers were generated by an LLM.
